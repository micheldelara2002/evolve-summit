...
- Name: auth-manager.setup.js >> authenticate manager
- Location: tests/e2e/auth-manager.setup.js:3:1

# Error details

```
Error: Missing E2E_MANAGER_EMAIL or E2E_MANAGER_PASSWORD. Configure the manager test account in the test environment.
```
